    ...
    for epoch in range(args.epoches):
        ...
        if (epoch+1)%1==0:
            for i in range(24):
                ...
                viz.images(show_pred, nrow=args.qry, win='pred:{}'.format(i), opts=dict(title='{%.2f}/{%.2f}/{%.2f}'%(pp,ss,mm)))
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--cuda', type=str, help='device', default='cuda:5')
    ...
    argparser.add_argument('--env', type=str, help='visdom windows title', default='edsr')
