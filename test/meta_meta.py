...
from my_loss import *
# from model.MTL_x4_ import Mtl4
# from model.edsr_x4 import EDSR4
from model.edsr_x4_ import EDSR4
...
class Meta(nn.Module):
    ...
    def __init__(self,args):
        ...
        #元优化器
        self.meta_optim = optim.AdamW(self.net.parameters(),lr=args.meta_lr)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--test', type=int, help='test number', default=12)
